...
export default function SignInModal() {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center px-4" onClick={() => setShowSignIn(false)}>
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="flex items-center space-x-2 mb-8">
            ...
            <span className="text-xl font-bold text-[#1e293b]">Cultura Vancouver</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            {['Google', 'Facebook'].map(provider => (
              <button
                key={provider}
                onClick={() => login(`user@${provider.toLowerCase()}.com`, `${provider} User`)}
