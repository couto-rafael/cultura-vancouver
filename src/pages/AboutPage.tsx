import { Globe, Calendar, Mail, Linkedin, CheckCircle } from "lucide-react";
...
const milestones = [
  {
    year: "2024",
    event: "Idea born at a SFU MBA class on social entrepreneurship",
  },
  {
    year: "Early 2025",
    event: "First 20 cultural associations onboarded as founding partners",
  },
  {
    year: "Mid 2025",
    event: "Beta launched with 50 events and 500 users in Vancouver",
  },
  {
    year: "Late 2025",
    event: "Expanded to Richmond and Burnaby; 5,000 registered users",
  },
  {
    year: "2026",
    event: "Platform-wide launch across Metro Vancouver — you are here 🎉",
  },
];
      ...
      <div className="bg-gradient-to-br from-[#1e293b] to-[#334155] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 leading-relaxed">
            Cultura Vancouver started with a simple frustration: too many
            incredible cultural events happened in this city, and too few people
            knew about them. We're changing that.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl font-bold text-[#1e293b] mt-2 mb-4">
              One platform. Every culture. All of Vancouver.
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Metro Vancouver is one of the most diverse regions on Earth. Over
              200 ethnic origins, 150 languages, and thousands of cultural
              events happening every month — yet most remain invisible to people
              outside their immediate community.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              Cultura Vancouver is the connective tissue. We aggregate cultural
              events from community associations, cultural centres, and
              individual organizers, making them discoverable to anyone curious
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-green-50 to-blue-50 rounded-2xl p-8 text-center">
              ...
              <blockquote className="text-lg font-medium text-[#1e293b] italic leading-relaxed">
                "Cultural exchange is not about assimilation — it's about
                enrichment. When we understand each other's celebrations, we
                understand each other."
              </blockquote>
              <p className="text-gray-500 text-sm mt-4">
                — Sofia Andrade, Co-Founder
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {values.map((v) => (
              <div
                key={v.title}
                className="bg-white rounded-xl p-6 shadow-sm flex items-start space-x-4"
              >
            ...
            <div key={i} className="flex items-start space-x-4">
              ...
              <div className="flex-shrink-0 flex flex-col items-center">
                ...
                {i < milestones.length - 1 && (
                  <div className="w-0.5 h-12 bg-green-200 mt-1" />
                )}
              </div>
              <div className="flex-1 pb-6">
                <div
                  className={`flex items-start space-x-2 ${i === milestones.length - 1 ? "bg-green-50 border border-green-200 rounded-xl px-4 py-3" : ""}`}
                >
                  {i === milestones.length - 1 && (
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 mt-2">
              A diverse crew of Vancouverites who care deeply about community.
            </p>
          </div>
            ...
            {team.map((member) => (
              ...
              >
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-1 text-white/60 hover:text-white text-xs transition"
                >
      ...
      <div className="py-16 px-4 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            Cultural associations, community centres, and event organizers — we
            want to amplify your work. Reach out to become a Cultura Vancouver
            partner.
          </p>
