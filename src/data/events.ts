...
export const events: Event[] = [
  ...
  },
  {
    ...
    fullDescription:
      "Experience the vibrant flavors of Brazil at Granville Island! Sample authentic Brazilian street food, pastries, tropical fruits, and beverages from award-winning vendors. Learn about Brazilian food culture through interactive cooking demonstrations and tastings.",
  ...
  },
  {
    ...
    fullDescription:
      "Vancouver's most anticipated cultural celebration returns! Join thousands as we celebrate the Lunar New Year with spectacular dragon and lion parades, traditional lion dances, cultural performances, fireworks display, martial arts demonstrations, and authentic Chinese cuisine.",
  ...
  },
  {
    ...
    fullDescription:
      "Join acclaimed Indigenous storytellers as they share traditional and contemporary stories that celebrate Indigenous cultures, histories, and wisdom. This intimate evening showcases oral traditions that have been passed down through generations.",
  ...
  },
  {
    ...
    fullDescription:
      "Robson Street comes alive with the energy of Korea! Browse food vendors offering Korean street food classics — tteokbokki, hotteok, Korean fried chicken, and more. Enjoy live K-pop performances, karaoke contests, cultural booths, and shopping from local Korean businesses.",
